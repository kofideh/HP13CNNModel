...
#Model training 
To train the model, first specify your acquisition parameters 
in train_hybrid_multihead.py (see the file for example). Then run:
python train_hybrid_multihead.py


To test the model, specify the weight path in the code and (see robust_clinical_inference.py for details) and run the following command:
